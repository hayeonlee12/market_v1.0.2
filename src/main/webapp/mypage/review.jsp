			...
			<div class="css-171zbec eug5r8l0">
				<div class="css-j0lifa ed9qr673">
					<div class="css-fhxb3m ed9qr672">
						<h2 class="css-1268zpe ed9qr671">상품 후기</h2>
					</div>
				</div>
				...
				<div class="css-1jdq78j e1cucsfi1" style="border-bottom: 2px solid;">
					<div style="width: 250px; text-align: center; font-weight: bold;">작성자</div>
					<div style="width: 300px; text-align: center; font-weight: bold;">후기내용</div>
					<div style="width: 250px; text-align: center; font-weight: bold;">작성일자</div>
				</div>
				<ul style="padding-left: 0px;  margin-top: 0px;">
					<c:forEach items="${reviewList }" var="review" varStatus="status">
						<li>
							<div class="css-1jdq78j e1cucsfi1">
								<div style="width: 250px; text-align: center;">${review.username }</div>
								<div style="width: 300px; text-align: center;">${review.anntitle }</div>
								<div style="width: 250px; text-align: center;">${review.anndate }</div>
							</div>
						</li>
