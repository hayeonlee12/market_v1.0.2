	...
	<div id="__next" data-reactroot="">
		<div class="css-sv3mbe e1u1sq1y0">
			<div class="css-ixlb9s ecqulhg2">
				...
				<div class="css-a0w530 ecqulhg1" id="checked">
					<label class="css-1wkyvs2 e1dcessg3">
					<input type="checkbox" 
						class="css-agvwxo e1dcessg2" onclick="check()">
...
function submit1(userid) {
	...
	if($("#checked input").is(":checked")) {
		window.opener.location.href="/mypage/NewLocation.lo?addr="+str+"&userid="+userid+"&locbasic=1";
	} else {
		window.opener.location.href="/mypage/NewLocation.lo?addr="+str+"&userid="+userid+"&locbasic=0";
	}
	window.close();
}
...
function check() {
	if(!$("#checked input").is(":checked")) {
		$("#checked path").attr("d","M23.5 12C23.5 18.3513 18.3513 23.5 12 23.5C5.64873 23.5 0.5 18.3513 0.5 12C0.5 5.64873 5.64873 0.5 12 0.5C18.3513 0.5 23.5 5.64873 23.5 12Z");
		$("#checked path").attr("stroke","#ddd");
		$("#checked path").attr("fill","#f2f2f2");
	} else {
		$("#checked path").attr("d","M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24Z");
		$("#checked path").removeAttr("stroke");
		$("#checked path").attr("fill","#5f0080");
	}
}
</script>
</html>