	        ...
	        <div style="width: 820px;">
                    ...
                    <table id="noticeboard">
                        <tr align="center" valign="middle">
                            ...
                            <td style="width: 720px;">[이벤트] 3월의 봄날의 펫페어 기부 이벤트 공지의건</td> 
                        </tr>
                        <tr align="center" valign="middle">
                        ...
                        <tr align="center" valign="middle">
                      		...
                      		<td style="width: 80%;" >2023.02.13</td>
                        </tr>
                        <tr align="center" valign="middle">
                        	<th style=" font-size: 13px; text-align: center; border-right: double #00000047">내용</th>
                            <td height="23px">
                            	고객님 안녕하세요.<br>
                            	지난 3월 16일 부터 23일까지 진행된 봄날의 펫페어 기부 이벤트 관련 내역 공유 드립니다. <br>
                            	이벤트 결과 총 1000KG의 사료를 3월 30일 레인보우 쉽터에 전달하였습니다.<br>
                            	펫페어 기부 이벤트에 보내주신 많은 관심에 진심으로 감사드립니다.<br>
                            	감사합니다.<br>
                            	컬리 드림
                            	
							<img  src="image/3.JPG" alt="3번공지" width="700px">
                            </td>
                        </tr>
                    </table>
