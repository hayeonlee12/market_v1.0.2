...
public class MarketLoginDAO {
	...
	public int basketCnt(String userid) {
		return sqlsession.selectOne("Market.basketCnt",userid);
	}
	
	public String basicLocation(String userid) {
		return sqlsession.selectOne("Market.basicLoc",userid);
	}
